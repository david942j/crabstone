...
module TestXCore
  XCORE_CODE = "\xfe\x0f\xfe\x17\x13\x17\xc6\xfe\xec\x17\x97\xf8\xec\x4f\x1f\xfd\xec\x37\x07\xf2\x45\x5b\xf9\xfa\x02\x06\x1b\x10\x09\xfd\xec\xa7".freeze
    ...
    if insn.op_count > 0
      ...
      insn.operands.each_with_index do |op, idx|
        ...
        when OP_MEM
          ...
          sio.puts "\t\t\toperands[#{idx}].mem.direct: -1" if op.value[:direct] != 1
        end
      end
    end
    sio.puts
